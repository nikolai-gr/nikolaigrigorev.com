...
const mediaPanels = [
  ...
  { id: "panel-5", src: aboutMedia1, alt: "Nikolai at car event detail" },
];
          ...
          >
            ...
            >
              <div className="grid grid-cols-12 gap-4 md:gap-5">
                ...
                <div className="col-span-3 flex gap-2 md:gap-2.5">
                  {mediaPanels.slice(1).map((panel, idx) => {
                    ...
                    return (
                      <motion.button
                        ...
                        onMouseEnter={() => setActivePanel(panelIndex)}
                        onFocus={() => setActivePanel(panelIndex)}
